...
class Flags {
	...
	@:lazy public static var VERSION_MESSAGE:String = 'RnK Engine v$VERSION';

	public static var REPO_NAME:String = "RnK-FNF";
	public static var REPO_OWNER:String = "kitcliffofc1-ship-it";
